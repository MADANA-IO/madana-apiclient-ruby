...
module   MadanaSampleclientRuby
  class RequestServiceApi
    ...
    # @return [File]
    def get_all_requests2(opts = {})
      data, _status_code, _headers = get_all_requests2_with_http_info(opts)
      data
    end
    ...
    # @return [Array<(File, Integer, Hash)>] File data, response status code and response headers
    def get_all_requests2_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: RequestServiceApi.get_all_requests2 ...'
      end
      # resource path
      local_var_path = '/requests'
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: RequestServiceApi#get_all_requests2\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_status_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: RequestServiceApi.get_status ...'
      end
      # resource path
      local_var_path = '/requests/stats'
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: RequestServiceApi#get_status\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
