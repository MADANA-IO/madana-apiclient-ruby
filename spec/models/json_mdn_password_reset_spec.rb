...
# Unit tests for OpenapiClient::JsonMDNPasswordReset
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'JsonMDNPasswordReset' do
  before do
    # run before each test
    @instance = OpenapiClient::JsonMDNPasswordReset.new
  end
  ...
  describe 'test an instance of JsonMDNPasswordReset' do
    it 'should create an instance of JsonMDNPasswordReset' do
      expect(@instance).to be_instance_of(OpenapiClient::JsonMDNPasswordReset)
    end
  end
